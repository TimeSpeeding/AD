...
public class RequestListByPersonAdapter extends BaseAdapter {
    private List<Request> list;
    private LayoutInflater inflater;

    public RequestListByPersonAdapter(Context context, List<Request> list){
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.list_request_by_person, null);
