...
class SimpleMonthView extends View {
    ...
    void setDaySelectorColor(ColorStateList dayBackgroundColor) {
        ...
        // TODO: expose as attr?
        mDayRangeSelectorPaint.setAlpha(255);
        invalidate();
    }
    ...
    private void drawDays(Canvas canvas) {
        ...
        // Get the original paint parameters for reset paint object.
        final int originalColor = mDayRangeSelectorPaint.getColor();
        final float originalStrokeWidth = mDayRangeSelectorPaint.getStrokeWidth();
        final float newStrokeWidth = colWidth / 30f;
            ...
            if (isSelected) {
                ...
                switch (bgShape) {
                    case DRAW_RECT_WITH_CURVE_ON_LEFT:
                        ...
                        canvas.drawArc(leftArcRect, 90,
                                180, true, mDayRangeSelectorPaint);
                        ...
                        mDayRangeSelectorPaint.setColor(convertColorBrightness(originalColor, 40));
                        drawTriangle(canvas, mDayRangeSelectorPaint,
                                new Point((int)(leftArcRect.centerX() + (colWidth / 6f)),
                                        (int)(rowCenter - rowHeight / 2f + mPaddingRangeIndicator)),
                                new Point((int)(colCenterRtl + colWidth / 2f),
                                        (int)(leftArcRect.centerY())),
                                new Point((int)(colCenterRtl + colWidth / 2f),
                                        (int)(rowCenter - rowHeight / 2f + mPaddingRangeIndicator)));
                        drawTriangle(canvas, mDayRangeSelectorPaint,
                                new Point((int)(leftArcRect.centerX() + (colWidth / 6f)),
                                ...
                                new Point((int)(colCenterRtl + colWidth / 2f),
                                        (int)(rowCenter + rowHeight / 2f - mPaddingRangeIndicator)));
                        mDayRangeSelectorPaint.setColor(originalColor);

                        mDayRangeSelectorPaint.setColor(Color.WHITE);
                        mDayRangeSelectorPaint.setStrokeWidth(newStrokeWidth);
                        canvas.drawLine(leftArcRect.centerX() + (colWidth / 6f),
                                rowCenter - rowHeight / 2f + mPaddingRangeIndicator,
                                colCenterRtl + colWidth / 2f - newStrokeWidth,
                                leftArcRect.centerY(),
                                mDayRangeSelectorPaint);
                        canvas.drawLine(leftArcRect.centerX() + (colWidth / 6f),
                                rowCenter + rowHeight / 2f - mPaddingRangeIndicator,
                        ...
                        mDayRangeSelectorPaint.setColor(originalColor);
                        mDayRangeSelectorPaint.setStrokeWidth(originalStrokeWidth);
                    ...
                    case DRAW_RECT_WITH_CURVE_ON_RIGHT:
                        ...
                        canvas.drawArc(rightArcRect, 270,
                                180,true,mDayRangeSelectorPaint);
                        ...
                        drawTriangle(canvas, mDayRangeSelectorPaint,
                                new Point((int)(colCenterRtl - colWidth / 2f),
                                        (int)(rowCenter - rowHeight / 2f + mPaddingRangeIndicator)),
                                new Point((int)(rightArcRect.centerX() - (colWidth / 6f)),
                                        (int)(rowCenter - rowHeight / 2f + mPaddingRangeIndicator)),
                                new Point((int)(colCenterRtl - colWidth / 2f),
                                        (int)rightArcRect.centerY()));
                        drawTriangle(canvas, mDayRangeSelectorPaint,
                                new Point((int)(rightArcRect.centerX() - (colWidth / 6f)),
                                        (int)(rowCenter + rowHeight / 2f - mPaddingRangeIndicator)),
                                new Point((int)(colCenterRtl - colWidth / 2f),
                        ...
                        mDayRangeSelectorPaint.setColor(Color.WHITE);
                        mDayRangeSelectorPaint.setStrokeWidth(newStrokeWidth);
                        canvas.drawLine(rightArcRect.centerX() - (colWidth / 6f),
                                rowCenter - rowHeight / 2f + mPaddingRangeIndicator,
                                colCenterRtl - colWidth / 2f + newStrokeWidth,
                                rightArcRect.centerY(),
                                mDayRangeSelectorPaint);
                        canvas.drawLine(rightArcRect.centerX() - (colWidth / 6f),
                                rowCenter + rowHeight / 2f - mPaddingRangeIndicator,
                                colCenterRtl - colWidth / 2f + newStrokeWidth,
    ...
    private void drawTriangle(Canvas canvas, Paint paint, Point a, Point b, Point c) {
        Path path = new Path();
        path.moveTo(a.x, a.y); // Top
        path.lineTo(b.x, b.y); // Bottom left
        path.lineTo(c.x, c.y); // Bottom right
        path.lineTo(a.x, a.y); // Back to Top
        path.close();

        canvas.drawPath(path, paint);
    }

    private int convertColorBrightness(int color, int brightness) {
        if (brightness <= -100) {
            brightness = -100;
        }
        ...
        int r = (int) (Color.red(color) + ((255 - Color.red(color)) * (brightness / 100f)));
        int g = (int) (Color.green(color) + ((255 - Color.green(color)) * (brightness / 100f)));
        int b = (int) (Color.blue(color) + ((255 - Color.blue(color)) * (brightness / 100f)));
